...
Widget cultureInfoItem(BuildContext context, BoxConstraints constraints, item) {
  ...
  print("seq value: ${item["seq"]}");
  print("seq type: ${item["seq"].runtimeType}");
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  item["place"],
                  style: Theme.of(context).textTheme.displaySmall!.copyWith(fontWeight: FontWeight.w500), maxLines: 1, overflow: TextOverflow.ellipsis,
                ),
                SizedBox(
                  height: 2.0,
                ),
